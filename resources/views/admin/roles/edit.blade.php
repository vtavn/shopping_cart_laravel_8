                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <form action="{{route('admin.roles.update', ['id' => $role->id])}}" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{old('name') ?? $role->name}}" placeholder="Tên Nhóm...">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="display_name" id="display_name" class="form-control" value="{{old('display_name') ?? $role->display_name}}" placeholder="Tên hiển thị (mô tả)...">
                                    @error('display_name')
                                    <span style="color: red;">{{$message}}</span>
                                    @enderror
                                </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label>
                                                            <input  type="checkbox" name="permission_id[]"
                                                                    {{ $role->permissions->contains('id' , $permissionsChildItem->id) ? 'checked' : ''}}
