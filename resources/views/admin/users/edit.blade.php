                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <form action="{{route('admin.users.update', ['id' => $user->id])}}" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{old('name') ?? $user->name}}" placeholder="Họ tên...">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control" value="{{old('email') ?? $user->email}}" placeholder="Email...">
                                    @error('email')
                                    <span style="color: red;">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="password">Mật khẩu (nhập để đổi mật khẩu)</label>
